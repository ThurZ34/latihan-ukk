...
export default function Home({ kategoris, riwayat, filters }) {
    ...
    const [searchNis, setSearchNis] = useState(filters?.search || "");
    const [isSearching, setIsSearching] = useState(false);
    useEffect(() => {
        if (searchNis === (filters?.search || "") && searchNis === "") return;
                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="font-bold text-xl tracking-tight text-gray-900">
                                Siswa
                                <span className="text-blue-600">Pengaduan</span>
                            </span>
                        </div>
                        <div className="flex items-center">
                            <a
                                href="/dashboard"
                                className="text-sm font-semibold text-gray-500 hover:text-blue-600 transition-colors px-3 py-2 hover:bg-gray-50 rounded-md"
                            >
                                Login Admin
                            </a>
                        </div>
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                            <div className="p-6">
                                ...
                                <p className="text-sm text-gray-500 mb-5">
                                    Sampaikan aspirasi Anda dengan detail.
                                </p>
                                ...
                                >
                                    <div>
                                        ...
                                        <input
                                            type="number"
                                            placeholder="Masukkan NIS Klean"
                                            value={data.nis}
                                            onChange={(e) =>
                                    ...
                                    <div>
                                        <label className="block text-sm font-semibold text-gray-700 mb-1">
                                            Foto Bukti(Opsional ya kawan kawan)
                                        </label>
                                        <input
                                            type="file"
                                            accept="image/*"
                            ...
                            {riwayat ? (
                                        ...
                                        >
                                            <div className="flex flex-col sm:flex-row justify-between sm:items-start gap-4 mb-3">
                                                ...
                                                <div className="flex-shrink-0">
                                                    <span
                                                        className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold ${getStatusBadge(item.status)}`}
                                                    >
                                                        {item.status}
                                                    </span>
                                                </div>
                                ...
                                <div className="text-center py-20 bg-white rounded-xl shadow-sm border border-gray-200">
                                    ...
                                    <p className="mt-2 text-gray-500 max-w-sm mx-auto text-sm">
                                        Masukkan NIS Anda pada kolom pencarian
                                        di atas untuk melihat riwayat aspirasi.
                                    </p>
                                </div>
                            )}
                        </div>
